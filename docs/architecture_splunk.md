...
- **Gemini 2.0 Flash** generates state-aware explanations (existing `gemini_adapter.py`).
- Future: Splunk MCP Server queries for cross-session attention trends (agentic investigation).
